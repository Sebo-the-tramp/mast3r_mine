# CUDA_VISIBLE_DEVICES=7 TORCH_DISTRIBUTED_DEBUG=INFO torchrun --nproc_per_node 1 --master_addr=127.0.0.1 --master_port=29502 train.py \
CUDA_VISIBLE_DEVICES=3,4 torchrun --nproc_per_node 2 --master_addr=127.0.0.1 --master_port=29502 train.py \
    ...
    --output_dir="/data3/sebastian.cavada/experiments/small/dust3r_512dpt_finetuned_10k_mod_ext+int_small"