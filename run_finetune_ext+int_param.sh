...
CUDA_VISIBLE_DEVICES=3,5,6,7 torchrun --nproc_per_node 4 --master_addr=127.0.0.1 --master_port=29502 train.py \
    ...
    --output_dir="/data3/sebastian.cavada/experiments/dust3r_512dpt_finetuned_100k_mod_ext+int_decoder"
