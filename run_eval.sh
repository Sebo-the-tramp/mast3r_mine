CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node 1 --master_addr=127.0.0.1 --master_port=29500 train.py \
    ...
    --lr=0.00001 --min_lr=1e-07 --warmup_epochs=0 --epochs=0 --batch_size=2 --accum_iter=8 \
    --save_freq=5 --keep_freq=10 --eval_freq=1 --print_freq=5 --disable_cudnn_benchmark \
    --output_dir="checkpoints/dust3r_512dpt_eval"
